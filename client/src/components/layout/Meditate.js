        ...
        <section >
            ...
            <div className="bg-white lg:min-w-0 lg:flex-1 z-20 lg:ml-52 mt-16">
                ...
                <div className="flex flex-col min-w-0 items-center mt-0">
                    <h2 className="text-2xl leading-7 text-beaTextGrey sm:text-2xl sm:truncate font-extralight">
                    Meditate
                    </h2>
                </div>
                </div>
                ...
                <div className="flex items-center px-4 py-0 border-b border-gray-200 sm:px-6 md:h-80 h-auto py-8 md:py-0 bg-gradient-to-t from-beaBlue to-white">
                <div className="md:pl-10 h-full w-full flex md:flex-row flex-col-reverse items-center">
                    <div className="flex flex-col lg:ml-4 ml-0 mt-2 md:w-5/12 w-auto items-center md:items-start">
                    ...
                    <button type="button" className="relative group transition-all hover:bg-transparent hover:text-beaDarkPurple hover:border-beaDarkPurple inline-flex items-center px-6 py-2 border border-transparent shadow-sm text-sm font-medium rounded-full text-white bg-beaDarkPurple focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
