...
class PlanLineGraph2 extends React.Component {
    constructor(props){
        super(props);
...
updateCharts() {
    console.log('this.data in updateCharts has', this.state.data);
    const max = 90;
    const min = 30;
  ...
  render() {
    ...
    console.log('this.data has', this.state.data);
